...
#ifndef __LINUX_LC_CP_CLASS_H__
#define __LINUX_LC_CP_CLASS_H__
...
struct chargerpump_ops {
	...
	int (*set_otg)(struct chargerpump_dev *, bool);
	int (*set_ovp_gate)(struct chargerpump_dev *, bool);
	...
	int (*get_cp_vendor)(struct chargerpump_dev *);
...
#endif /* __LINUX_LC_CP__CLASS_H__ */
