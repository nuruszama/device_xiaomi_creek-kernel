...
enum BC12_RESULT {
    ...
    APPLE_3A_DETECTED   = (1 << 4) | NON_STANDARD_DETECTED,
    APPLE_2_1A_DETECTED = (2 << 4) | NON_STANDARD_DETECTED,
    SS_2A_DETECTED      = (3 << 4) | NON_STANDARD_DETECTED,
    APPLE_1A_DETECTED   = (4 << 4) | NON_STANDARD_DETECTED,
    APPLE_2_4A_DETECTED = (5 << 4) | NON_STANDARD_DETECTED,
};
