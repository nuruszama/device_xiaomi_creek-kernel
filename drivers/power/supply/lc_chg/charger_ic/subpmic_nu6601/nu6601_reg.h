...
/* Register 0x29h */
#define NU6601_REG_CHG_DIS_NOK_FLAG		(0x29)
#define FAST_CHG_TIMER_EXP				(0X04)
...
#define NU6601_REG_VAC_OVP					(0x40)
	...
	#define VAC_OVP_FORCE_MASK				(0x04)
	#define VAC_OVP_FORCE					(2)
...
#define NU6601_REG_BOOST_PORT_EN				(0x5A)
	...
	#define	BOOST_PROT_EN_MASK          (0x20)
	#define BOOST_PROT_EN_SHIFT         (5)
...
#define NU6601_REG_QC_COT_PULSE			(0xBB)
	#define QC3P5_PULSE_ONE_STEP	1
/*
 *    #define NO_ACTION			(0)
 *    #define DP_16PULSE			(1)
 *    #define DM_16PULSE			(2)
