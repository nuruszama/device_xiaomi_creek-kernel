...
static int gf_pinctrl_init(struct gf_dev *gf_dev)
{
	...
	gf_dev->gf_pwr_high = pinctrl_lookup_state(gf_dev->pinctrl_gpios, "xiaomifp_ldo_outputhigh");
	...
	gf_dev->gf_pwr_low = pinctrl_lookup_state(gf_dev->pinctrl_gpios, "xiaomifp_ldo_outputlow");
